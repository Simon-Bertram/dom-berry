        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-16 text-center">
            ...
            <p className="font-body text-gray-600 text-xl dark:text-gray-300">
              Professional filmmaker based in Stroud, Gloucestershire
            </p>
          </header>
          ...
          <div className="space-y-12">
            ...
            <section className="rounded-xl bg-white p-8 shadow-lg dark:bg-gray-800">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
                <p className="mb-4">
                  Dom Berry is a professional videography service based in
                  Stroud, Gloucestershire, specializing in high-quality film
                  production across the South West UK. We bring stories to life
                  through cinematic storytelling, capturing moments that matter.
                </p>
                <p className="mb-4">
                  From corporate films and live events to weddings and marketing
                  videos, we deliver exceptional results that exceed
                  expectations. Our team combines technical expertise with
                  creative vision to produce compelling content that resonates
                  with your audience.
                </p>
                <p>
                  Based in Stroud, Gloucestershire, we serve clients across the
                  South West UK including Bristol, Bath, Cheltenham, and the
                  Cotswolds with a commitment to professionalism, quality, and
                  timely delivery.
                </p>
              </div>
            </section>
